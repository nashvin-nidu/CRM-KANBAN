...
const allLeads = ref([
    { id: 1, name: 'Alice Smith', email: 'alice@example.com', company: 'Acme Corp', status: 'New', value: 12500, source: 'Website', date: '2026-06-05' },
    { id: 2, name: 'Bob Johnson', email: 'bob@example.com', company: 'Infinite Loop', status: 'Contacted', value: 45000, source: 'Referral', date: '2026-06-03' },
    { id: 3, name: 'Charlie Brown', email: 'charlie@example.com', company: 'Peanuts Inc', status: 'Qualified', value: 8000, source: 'LinkedIn', date: '2026-06-02' },
    { id: 4, name: 'Diana Prince', email: 'diana@example.com', company: 'Wayne Ent.', status: 'Proposal Sent', value: 95000, source: 'Direct', date: '2026-05-30' },
    { id: 5, name: 'Ethan Hunt', email: 'ethan@example.com', company: 'IMF Agency', status: 'Won', value: 150000, source: 'Referral', date: '2026-05-28' },
    { id: 6, name: 'Fiona Gallagher', email: 'fiona@example.com', company: 'Patsy\'s Pies', status: 'Lost', value: 3200, source: 'Cold Call', date: '2026-05-25' },
]);
    ...
    <div class="flex h-full flex-1 flex-col gap-6 p-6 overflow-x-auto">
        ...
        <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="text-muted-foreground">Manage and track your sales opportunities.</p>
            </div>
        ...
        <Card class="border-sidebar-border/70 dark:border-sidebar-border overflow-hidden shadow-sm">
            <div class="px-6">
                <Table>
                    ...
                    <TableBody>
                        <TableRow v-for="lead in filteredLeads" :key="lead.id" class="hover:bg-muted/50 transition-colors">
                            ...
                            <TableCell>
                                <Badge :variant="getStatusVariant(lead.status)" :class="getStatusClass(lead.status)">
                                    {{ lead.status }}
                                </Badge>
                            </TableCell>
